...
from tools.tokenizers import LDCCSolarTokenizer
from utils import print_mem_consumption


# LDCC trained Solar model
class LDCCSolar(nn.Module):
    def __init__(self, config, device):
        super(LDCCSolar, self).__init__()
        self.model_path = 'LDCC/LDCC-SOLAR-10.7B'
        self.device = device
        ...
        self.tokenizer = LDCCSolarTokenizer(self.model_path)
