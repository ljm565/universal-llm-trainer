...
from univlt.tools.tokenizers import Phi3Tokenizer
...
class Phi3(nn.Module):
    def __init__(self, cfg: TrainingConfig, device):
        ...
        self.tokenizer = Phi3Tokenizer(cfg.data_cfg, self._model_path)
    ...
    def __set_gradient_checkpointing(self, cfg: TrainingConfig):
        if cfg.gradient_checkpointing:
            if cfg.gradient_checkpoint_type.lower() == 'torch_checkpoint':
                ...
                auto_wrap_policy=ModuleWrapPolicy({Phi3DecoderLayer})
