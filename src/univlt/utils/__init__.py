...
# Initialize
version_file_path = resources.files("univlt").joinpath("version.txt")
LOGGING_NAME = f"UnivLT_{open(version_file_path).read().strip()}"
VERBOSE = True
...
DATASET_TRAIN_TYPE_MSG = 'Currently, we only support' + f' [{colorstr("sft")}, {colorstr("ar")}, and {colorstr("arc")}] ' + 'as dataset_train_type'
